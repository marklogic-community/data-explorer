...
angular.module('demoApp')
    .controller('AdhocWizardTypeQueryCtrl', function($state, $scope, $http, $stateParams, $sce, $interval, databaseService, wizardService) {
        ...
        $scope.searchTypeDescription[$scope.searchTypeCollectionName] = {
            title: "Collection name",
            message: "Please enter a collection name!"
        };
        $scope.searchTypeDescription[$scope.searchTypeDirectory] = {
            title: "Directory name",
            message: "Please enter Directory name to search"
        };
        $scope.searchTypeDescription[$scope.searchTypeRootName] = {
            title: "Root Element Name",
            message: ""
        };
        $scope.searchTypeDescription[$scope.searchTypePartialUri] = {
            title: "URI",
            message: "Enter partial uri (wildcard pattern) or a complete URI"
        };
        ...
        $scope.next = function() {
            $scope.searchDocuments("", "next");
        };
        $scope.prev = function() {
            $scope.searchDocuments("", "prev");
        };
