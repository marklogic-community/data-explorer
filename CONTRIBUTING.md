# Contributing to the MarkLogic Data Explorer Project

Want to contribute? This document will guide you through the process.
...
* **Data Explorer Version** - is it a named version or from our dev branch
...
Fork the project [on GitHub](https://github.com/marklogic-community/data-explorer/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/data-explorer.git
$ cd data-explorer
$ git remote add upstream git://github.com/marklogic-community/data-explorer.git
```
...
We are working hard to improve Data Explorer's testing. If you add new functions, please write unit tests and verify that the tests work.  Make sure that all tests pass. Please, do not submit patches that fail.
...
Go to https://github.com/username/data-explorer and select your feature branch. Click
...
[issue tracker]: https://github.com/marklogic-community/data-explorer/issues
